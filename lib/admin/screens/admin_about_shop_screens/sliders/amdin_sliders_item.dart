...
class AdminSlidersItem extends StatelessWidget {
  ShowSlider slider;
  AdminSlidersItem({
    Key? key,
 ...
 // final ProductsController _productsController = Get.put(ProductsController());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        //_productsController.categoryId.value = slider.cid;
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(
                              color:
                                  slider.status ? Colors.green : Colors.red,
                              width: 2),
                          shape: BoxShape.circle,
